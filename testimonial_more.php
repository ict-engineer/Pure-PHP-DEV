...
$testimonial=$dbf->fetchSingle("testimonial","id='$_REQUEST[id]'");
?>
<body><?php include 'header.php';?><nav><div class="menubar"><?php include 'menu.php';?></div></nav> <div class="contentouterdiv"> <div class="contentsecdiv"> <div class="contentleftdiv"> <div class="bannerdiv"><?php include 'banner.php';?></div> <div class="spacer1"></div> <div class="spacer2"></div><div class="contentsec1"> <h1>Testimonial</h1> <div class="contxt">"<?php echo stripslashes($testimonial[descr]);?>"<br /></div> <div align="right" class="testimonialname"><?php echo stripslashes($testimonial[name]);?></div> <div style="height:20px;"></div> </div><div class="shadow"><img src="images/shadow.png" /></div> </div> <div class="contentrightdiv"><?php include 'right_menu.php';?></div> <div class="spacer2"></div> <div class="spacer1"></div> </div> </div><footer><?php include('footer.php'); ?></footer></body></html>