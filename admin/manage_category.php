...
<script type="text/javascript">
	...
	//This function is used for left menu	
                ...
                <td align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      ...
                      <td class="midboxbg"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                          <td width="50%" align="left" valign="middle"><h2>Manage Category</h2></td>
				...
				<table width="100%" border="0" cellspacing="0" cellpadding="0">
                  ...
                  <tr>
					...
					<table height="61" border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#ACACAC"  class="tablesorter" id="sort_table" width="100%">
                      <thead>
                        <tr>
                          <th width="93%" height="27" align="left" valign="middle" class="fetch_headers"> Category Name</th>
                      ...
                      <tbody>
                        <?php
						 $num=$dbf->countRows('category_tbl');
						 foreach($dbf->fetch('category_tbl',"","id","","ASC") as $res) {
			            ?>
                        <tr bgcolor="<?=$color;?>"  onmouseover="this.style.backgroundColor='#E6E6E6'" onMouseOut="this.style.backgroundColor=''">
                          <td height="25" align="left" class="fetch_contents"><?php echo $res[category_name];?></td>
						  <td width="7%" align="center" bgcolor="<?=$color;?>" class="fetch_contents">
						   <a href="edit_category.php?id=<?php echo $res[id];?>"  class="linktext"><img src="images/edit.png" width="18" height="18" title="Edit"></a></td>
                        </tr>
                        <?php } ?>
                        <?php if($num==0) { ?>
                        <tr>
