...
{	
	...
	$path="../banner_img/banner/".$fileName;
	if(file_exists($path)){
		unlink($path);
	}
	
	$dbf->deleteFromTable("banner","id='$_REQUEST[id]'");
        ...
        <td align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          ...
          <tr>
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
                ...
                <td align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      ...
                      <td class="midboxbg"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                          <td width="50%" align="left" valign="middle"><h2>Manage Banner </h2></td>
                          <td width="50%" align="right" valign="middle"><h2><a href="banner_add.php" class="linkButton">Add New </a></h2></td>
                        </tr>
                      </table></td>
              ...
              <tr>
                <td align="left" valign="top" bgcolor="#e2e2e2" height="353">
				<table width="100%" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    <td>&nbsp;</td>
                    <td width="1038">&nbsp;</td>
                  ...
                  <tr>
					...
					<table height="61" border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#ACACAC"  class="tablesorter" id="sort_table" width="100%">
                      <thead>
                        <tr>
                          <th width="86%" height="27" align="left" valign="middle" class="fetch_headers">Upload Banner </th>
						  <th colspan="4" align="center" valign="middle" class="fetch_headers">Action</th>
                          </tr>
                      </thead>
                      <tbody>
                        <?php
						 $num=$dbf->countRows('banner');
						 foreach($dbf->fetch('banner') as $res) {
			            ?>
                        <tr bgcolor="<?=$color;?>"  onmouseover="this.style.backgroundColor='#E6E6E6'" onMouseOut="this.style.backgroundColor=''">
                          <td height="25" align="left" class="fetch_contents"><img src="../banner_img/banner/<?php echo $res[image];?>" width="110" height="50" align="middle"/></td>
						   <td width="7%" align="center" bgcolor="<?=$color;?>" class="fetch_contents">
						   <a href="banner_edit.php?id=<?php echo $res[id];?>"  class="linktext">
						   <img src="images/edit.png" width="18" height="18" title="Edit"></a></td>
						   <td width="7%" align="center" bgcolor="<?=$color;?>" class="fetch_contents">
						   <a href="manage_banner.php?action=delete&id=<?php echo $res[id];?>" class="linktext" onClick="return confirm('Are you sure you want to delete this record ?')"><img src="images/trash.jpg" width="15" height="16" title="Delete"></a></td>
                          </tr>
                        <?php } ?>
                        <?php if($num==0) { ?>
                        <tr>
