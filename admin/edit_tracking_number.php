...
$pageTitle='Edit Tracking Number';
...
$trackid=base64_decode(base64_decode($_REQUEST[trackid]));
...
{	
	...
	//For Updating Vehicle Inspection Details=======================================
	  if($_FILES['vir']['name']!='') {
		...
		$unlink_vir=$dbf->fetchSingle("tracking_system_vehicle_report","id='$trackid'");
		$path="../vehicle_report/".$unlink_vir[uploaded_report];
		unlink($path);
	    //Upload vehicle_report ends here======================
	  }
	...
	header("Location:edit_tracking_number.php?msg=added&trackid=$trckid");
}
?>
                ...
                <td align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      ...
                      <td class="midboxbg"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                          <td width="50%" align="left" valign="middle"><h2>Edit Tracking Number</h2></td>
                              ...
                              <td height="25" align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                ...
                                <tr>
                                  <td height="25" colspan="2" align="left" valign="middle" class="text1">
                                    <textarea name="package_contents" id="package_contents"><?php echo strtoupper($res_trackinfo[package_contents]);?></textarea>
									<script type="text/javascript">
                                  ...
                                  <td>
                                    <table style="border:solid 1px #CCC; border-radius:5px; -moz-border-radius:5px;">
                                      <tbody>
                                        ...
                                        <tr>
                                          <td colspan="2" id="virphotoshow" style="display:;" align="center">
                                          <?php if($res_vir_report['uploaded_report']!=''){?><a href="../vehicle_report/<?php echo $res_vir_report[uploaded_report];?>" title="Vehicle Inspection Report" alt="Vehicle Inspection report" target="_blank"><img src="../vehicle_report/<?php echo $res_vir_report[uploaded_report];?>" width="150" height="200" border="1"></a><?php } ?></td>
                                        </tr>
                                ...
                                <td>
                                  <table style="border:solid 1px #CCC; border-radius:5px; -moz-border-radius:5px;">
                                     <tbody>
                                        ...
                                        <tr>
                                          <td colspan="2" id="bolphotoshow" style="display:;" align="center">
                                          <?php if($res_bil_report['uploaded_lading']!=''){ ?><a href="../billoflading_report/<?php echo $res_bil_report[uploaded_lading];?>" title="Bill of Lading" alt="Bill of Lading" target="_blank"><img src="../billoflading_report/<?php echo $res_bil_report[uploaded_lading];?>" height="200" width="150" border="1"></a><?php } ?></td>
                                        </tr>
                                        <tr>
                                          <td colspan="2" id="bolformshow" style="display:none;" align="center">
                                            <table style="border:solid 1px #CFCFCF; border-radius:5px; -moz-border-radius:5px; padding:5px;">
                                              <tbody>
                                                ...
                                                <tr>
                                                  <td align="left" valign="middle"><img src="billofladingsignature.php?text=<?php echo $res_admin[billof_lading_signature];?>&font=<?php echo $res_admin[billof_lading_signature_font];?>&size=<?php echo $res_admin['billof_lading_font_size'];?>" border="0" width="110"></td>
                                ...
                                <td>
                                  <table style="border:solid 1px #CCC; border-radius:5px; -moz-border-radius:5px;">
                                     <tbody>
                                        ...
                                        <tr>
                                          <td colspan="2" id="invoicephotoshow" style="display:;" align="center">
                                          <?php if($res_invoice_report['uploaded_invoice']!=''){ ?><a href="../invoice_report/<?php echo $res_invoice_report[uploaded_invoice];?>" title="Invoice" alt="Invoice" target="_blank"><img src="../invoice_report/<?php echo $res_invoice_report[uploaded_invoice];?>" width="150" height="200" border="1"></a><?php } ?></td>
                                        </tr>
                                        <tr>
                                  ...
                                  <table style="border:solid 1px #CCC; border-radius:5px; -moz-border-radius:5px;">
                                     <tbody>
                                        ...
                                        <tr>
                                          ...
                                          <?php if($res_trackinfo['proof_of_transfer']!=''){ ?><a href="../proof_of_transfer/<?php echo $res_trackinfo[proof_of_transfer];?>" title="Proof of Transfer" alt="Proof of Transfer" target="_blank"><img src="../proof_of_transfer/<?php echo $res_trackinfo[proof_of_transfer];?>" width="150" height="200" border="1"></a><?php } ?></td>
                                        </tr>
                                      </tbody>
                                    </table>
                                  </td>
