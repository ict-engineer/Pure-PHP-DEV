...
$pageTitle='Edit Transaction Originate';
...
$res=$dbf->fetchSingle("transaction_originate","id='$_REQUEST[id]'");

if(isset($_POST[submit])<>'')
{
	$dated=date("Y-m-d");
	$string="originate_from='$_POST[originate_from]',updated_date='$dated'";
	$dbf->updateTable("transaction_originate",$string,"id='$_REQUEST[id]'");
	
	header("Location:edit_transaction_originate.php?msg=added&id=$_REQUEST[id]");
}
?>
                ...
                <td align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      ...
                      <td class="midboxbg"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                          <td width="50%" align="left" valign="middle"><h2>Edit Transaction Originate</h2></td>
					...
					<form action="" method="post" id="frm" name="frm" enctype="multipart/form-data">
                      <table width="90%" height="191" border="0" align="center" cellpadding="0" cellspacing="0" style="margin-left:10px;">
                        ...
                        <tr>
                          ...
                          <td width="436" height="25" align="left" valign="middle"><input name="originate_from" value="<?php echo $res[originate_from];?>" type="text" class="validate[required] textfield121" id="originate_from" autocomplete="off"/></td>
