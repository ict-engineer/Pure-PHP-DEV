...
$res=$dbf->fetchSingle("faq","id='$_REQUEST[id]'");
...
if(isset($_POST[submit])<>'')
{
	...
	$dbf->updateTable("faq",$string,"id='$_REQUEST[id]'");
	header("Location:edit_faq.php?msg=added&id=$_REQUEST[id]");
}
?>
                ...
                <td align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      ...
                      <td class="midboxbg"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                          <td width="50%" align="left" valign="middle"><h2>Edit FAQs</h2></td>
                  ...
                  <tr>
					...
					<form action="" method="post" id="frm" name="frm" enctype="multipart/form-data">
                      <table width="90%" height="191" border="0" align="center" cellpadding="0" cellspacing="0" style="margin-left:10px;">
                        ...
                        <tr>
                          <td height="30" align="left" class="headingtext">&nbsp;</td>
                          <td height="30" align="left" valign="middle" class="text1">FAQ Type : </td>
                          <td align="left" valign="middle">
                          	<select name="faq_type" id="faq_type" class="validate[required] textfield121">
                          	  <option value="">--Select FAQ Type--</option>
                              <option value="Question About General Use" <?php if($res[faq_type]=="Question About General Use"){ echo "Selected";} ?>>Question About General Use</option>
                              <option value="Financial Question" <?php if($res[faq_type]=="Financial Question"){ echo "Selected";} ?>>Financial Question</option>
                            </select></td>
                          <td width="285" rowspan="5" align="left" valign="bottom" style="padding-bottom:10px;">&nbsp;</td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                          <td height="30" align="left" class="headingtext">&nbsp;</td>
                          <td width="137" height="30" align="left" valign="middle" class="text1">Question : </td>
                          <td width="410" align="left" valign="middle"><input name="question" type="text" class="validate[required] textfield121" id="question" value="<?php echo $res[question];?>" autocomplete="off"/></td>
                        </tr>
                        <tr>
                          <td height="5" colspan="3" align="left" class="headingtext"></td>
						</tr>
                        ...
                        <tr>
                          ...
                          <td height="30" colspan="3" align="left" valign="middle" class="">
                            <textarea name="answer" cols="45" rows="5" class="validate[required]" id="answer"><?php echo $res[answer];?></textarea>
