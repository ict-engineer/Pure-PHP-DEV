...
$pageTitle='Edit Terms & Condition';
...
$res=$dbf->fetchSingle("term_condition","id='$_REQUEST[id]'");

if(isset($_POST[submit])<>'')
{
	$dated=date("Y-m-d");
	$title=addslashes($_POST[title]);
	$string="title='$title',descr='$_POST[descr]',post_date='$dated'";
	
	$dbf->updateTable("term_condition",$string,"id='$_REQUEST[id]'");
	header("Location:edit_terms_condition.php?msg=added&id=$_REQUEST[id]");
}
?>
                ...
                <td align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      ...
                      <td class="midboxbg"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                          <td width="50%" align="left" valign="middle"><h2>Edit Terms & Condition</h2></td>
                          <td width="50%" align="right" valign="middle"><h2><a href="manage_terms_conditions.php" class="linkButton">BACK</a></h2></td>
                        </tr>
                      </table></td>
                  ...
                  <tr>
					...
					<form action="" method="post" id="frm" name="frm" enctype="multipart/form-data">
                      <table width="90%" height="191" border="0" align="center" cellpadding="0" cellspacing="0" style="margin-left:10px;">
                        ...
                        <tr>
                          <td height="30" align="left" class="headingtext">&nbsp;</td>
                          <td width="192" height="30" align="left" valign="middle" class="text1">Term&Condition Title : </td>
                          <td width="432" align="left" valign="middle"><input name="title" type="text" class="validate[required] textfield121" id="title" value="<?php echo $res[title];?>" autocomplete="off"/></td>
                          <td width="309" rowspan="3" align="left" valign="bottom" style="padding-bottom:10px;">&nbsp;</td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                          <td height="30" align="left" class="headingtext">&nbsp;</td>
                          <td height="30" align="left" valign="middle" class="text1">Term&Condition Description : </td>
                          <td align="left" valign="middle">&nbsp;</td>
                        </tr>
                        <tr>
                          <td width="42" height="30" align="left" class="headingtext">&nbsp;</td>
                        ...
                        <tr>
                          <td align="left">&nbsp;</td>
                          <td align="left"><input name="submit" type="submit" class="button" id="submit" value="Submit">&nbsp; <input name="submit2" type="button" class="button" id="submit2" value="Cancel" onClick="javascript:window.location='manage_terms_conditions.php'"></td>
