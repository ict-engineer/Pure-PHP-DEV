...
{	
	$dbf->deleteFromTable("faq","id='$_REQUEST[id]'");
                ...
                <td align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      ...
                      <td class="midboxbg"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                          <td width="50%" align="left" valign="middle"><h2>Manage FAQs</h2></td>
                          <td width="50%" align="right" valign="middle"><h2><a href="add_faq.php" class="linkButton">Add New </a></h2></td>
                        </tr>
                      </table></td>
				...
				<table width="100%" border="0" cellspacing="0" cellpadding="0">
                  ...
                  <tr>
					...
					<table height="61" border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#ACACAC"  class="tablesorter" id="sort_table" width="100%">
                      <thead>
                        <tr>
                          <th width="22%" align="left" valign="middle" class="fetch_headers">FAQ Type</th>
                          <th width="25%" height="27" align="left" valign="middle" class="fetch_headers"> Question</th>
                          <th width="45%" align="left" valign="middle" class="fetch_headers"> Answer</th>
						  <th colspan="4" align="center" valign="middle" class="fetch_headers">Action</th>
                        </tr>
                      </thead>
                      <tbody>
                        <?php
						 $num=$dbf->countRows('faq');
						 foreach($dbf->fetch('faq',"","id","","DESC") as $res_faq) {
			            ?>
                        <tr bgcolor="<?=$color;?>" onMouseOver="this.style.backgroundColor='#E6E6E6'" onMouseOut="this.style.backgroundColor=''">
                          <td align="left" class="fetch_contents"><?php echo $res_faq[faq_type];?></td>
                          <td height="25" align="left" class="fetch_contents"><?php echo $res_faq[question];?></td>
                          <td align="left" class="fetch_contents"><?php echo $dbf->cut(strip_tags($res_faq[answer]),200);?></td>
						  <td width="4%" align="center" bgcolor="<?=$color;?>" class="fetch_contents">
						   <a href="edit_faq.php?id=<?php echo $res_faq[id];?>"  class="linktext"><img src="images/edit.png" width="18" height="18" title="Edit"></a></td>
						  <td width="4%" align="center" bgcolor="<?=$color;?>" class="fetch_contents">
						   <a href="manage_faq.php?action=delete&id=<?php echo $res_faq[id];?>" class="linktext" onClick="return confirm('Are you sure you want to delete this record ?')"><img src="images/trash.jpg" width="15" height="16" title="Delete"></a></td>
                        </tr>
                        <?php } ?>
                        <?php if($num==0){ ?>
                        <tr>
                          <td colspan="9" align="center" class="noRecords"><span class="noRecords2">No Records Found</span> </td>
                        </tr>
						<?php } ?>
                      </tbody>
                    </table></td>
