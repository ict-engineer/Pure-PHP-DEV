...
if(isset($_POST[submit])<>'')
{
	...
	$dbf->insertSet("term_condition",$string);
	header("Location:add_terms_condition.php?msg=added");
}
?>
                ...
                <td align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      ...
                      <td class="midboxbg"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                          <td width="50%" align="left" valign="middle"><h2>Add Terms & Conditions</h2></td>
                  ...
                  <tr>
					...
					<form action="" method="post" id="frm" name="frm" enctype="multipart/form-data">
                      <table width="90%" height="191" border="0" align="center" cellpadding="0" cellspacing="0" style="margin-left:10px;">
                        ...
                        <tr>
                          <td height="30" align="left" class="headingtext">&nbsp;</td>
                          <td width="190" height="30" align="left" valign="middle" class="text1">Term&amp;Condition Title : </td>
                          <td width="434" align="left" valign="middle"><input name="title" type="text" class="validate[required] textfield121" id="title" autocomplete="off"/></td>
                        ...
                        <tr>
                          ...
                          <td height="30" colspan="3" align="left" valign="middle">
                            <textarea name="descr" cols="45" rows="5" class="validate[required]" id="descr"></textarea>
