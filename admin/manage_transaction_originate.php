...
$pageTitle='Manage Transaction Originate';
...
{	
	$dbf->deleteFromTable("transaction_originate","id='$_REQUEST[id]'");
	header("Location:manage_transaction_originate.php");
}
                ...
                <td align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      ...
                      <td class="midboxbg"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                          <td width="50%" align="left" valign="middle"><h2>Manage Transaction Originate</h2></td>
                          <td width="50%" align="right" valign="middle"><h2><a href="add_transaction_originate.php" class="linkButton">Add New </a></h2></td>
                        </tr>
                      </table></td>
				...
				<table width="100%" border="0" cellspacing="0" cellpadding="0">
                  ...
                  <tr>
					...
					<table height="61" border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#ACACAC"  class="tablesorter" id="sort_table" width="100%">
                      <thead>
                        <tr>
                          <th width="92%" height="27" align="left" valign="middle" class="fetch_headers">Name</th>
                          <th colspan="4" align="center" valign="middle" class="fetch_headers">Action</th>
                        </tr>
                      </thead>
                      <tbody>
                        <?php
						 $num=$dbf->countRows('transaction_originate');
						 foreach($dbf->fetch('transaction_originate',"","id","","DESC") as $res_transactionorig) {
			            ?>
                        <tr bgcolor="<?=$color;?>" onMouseOver="this.style.backgroundColor='#E6E6E6'" onMouseOut="this.style.backgroundColor=''">
                          <td height="25" align="left" class="fetch_contents"><?php echo $res_transactionorig[originate_from];?></td>
                          <td width="4%" align="center" bgcolor="<?=$color;?>" class="fetch_contents">
                            <a href="edit_transaction_originate.php?id=<?php echo $res_transactionorig[id];?>" class="linktext"><img src="images/edit.png" width="18" height="18" title="Edit"></a></td>
						  <td width="4%" align="center" bgcolor="<?=$color;?>" class="fetch_contents">
						    <a href="manage_transaction_originate.php?action=delete&id=<?php echo $res_transactionorig[id];?>" class="linktext" onClick="return confirm('Are you sure you want to delete this member ?')"><img src="images/trash.jpg" width="15" height="16" title="Delete"></a></td>
                        </tr>
                        <?php } ?>
                        <?php if($num==0){ ?>
                        <tr>
                          <td colspan="7" align="center" class="noRecords"><span class="noRecords2">No Records Found</span></td>
                        </tr>
						<?php } ?>
                      </tbody>
                    </table></td>
