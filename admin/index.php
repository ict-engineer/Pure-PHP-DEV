...
$pageTitle='Transmith Group || Control Panel';
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
        <td height="100" align="center" class="topheader"><?php include 'header.php';?></td>
      </tr>
      <tr>
      ...
      <tr>
		...
		<form action="" method="post" id="frm" name="frm">
          ...
          <tr>
            <td height="50" align="left" valign="middle" background="images/head_bg.jpg" bgcolor="#100b4d" class="logintext"> Admin Login </td>
          </tr>
          <tr>
            <td height="130" align="center" valign="top">
            <table width="380" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td height="30" colspan="4" align="center"><?php if($msg=='fail'){?><span class="error">Invalid Email ID or Password </span><?php }?></td>
                  </tr>
                <tr>
                  ...
                  <td colspan="2" align="left" valign="middle"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                      <tr>
						...
						<input name="email" type="text" class="textfield validate[required,custom[email]]" id="email" size="45" autocomplete="off"/></td>
                      </tr>
                      <tr>
