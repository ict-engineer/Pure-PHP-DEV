...
{	
	$dbf->deleteFromTable("tracking_bank","id='$_REQUEST[id]'");
                ...
                <td align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      ...
                      <td class="midboxbg"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                          <td width="50%" align="left" valign="middle"><h2>Manage Bank</h2></td>
				...
				<table width="100%" border="0" cellspacing="0" cellpadding="0">
                  ...
                  <tr>
					...
					<table height="61" border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#ACACAC"  class="tablesorter" id="sort_table" width="100%">
                      <thead>
                        <tr>
                          <th width="60%" height="27" align="left" valign="middle" class="fetch_headers">Name</th>
                          <th width="32%" align="left" valign="middle" class="fetch_headers">Payment Type</th>
						  <th colspan="4" align="center" valign="middle" class="fetch_headers">Action</th>
                        </tr>
                      </thead>
                      <tbody>
                        <?php
						 $num=$dbf->countRows('tracking_bank');
                        ...
                        <tr bgcolor="<?=$color;?>" onMouseOver="this.style.backgroundColor='#E6E6E6'" onMouseOut="this.style.backgroundColor=''">
                          <td height="25" align="left" class="fetch_contents"><?php echo $res_bank[name];?></td>
                          <td align="left" class="fetch_contents"><?php echo $res_bank[payment_type];?></td>
						  <td width="4%" align="center" bgcolor="<?=$color;?>" class="fetch_contents">
						   <a href="edit_bank.php?id=<?php echo $res_bank[id];?>" class="linktext"><img src="images/edit.png" width="18" height="18" title="Edit"></a></td>
						  <td width="4%" align="center" bgcolor="<?=$color;?>" class="fetch_contents">
						   <a href="manage_bank.php?action=delete&id=<?php echo $res_bank[id];?>" class="linktext" onClick="return confirm('Are you sure you want to delete this record ?')"><img src="images/trash.jpg" width="15" height="16" title="Delete"></a></td>
                        </tr>
                        <?php } ?>
                        <?php if($num==0) { ?>
                        <tr>
